...
* add dist ([e2d178f](https://github.com/hoai/vue-form-generator/commit/e2d178f))
* Add input-group-btn class to make button inline with input ([f5df53d](https://github.com/hoai/vue-form-generator/commit/f5df53d))
* Add label for checkbox ([56f115a](https://github.com/hoai/vue-form-generator/commit/56f115a))
* add listeners fields ([c6daac6](https://github.com/hoai/vue-form-generator/commit/c6daac6))
* add listeners to all fields ([6b5dd11](https://github.com/hoai/vue-form-generator/commit/6b5dd11))
* add ref parent to field & validators ([d005a71](https://github.com/hoai/vue-form-generator/commit/d005a71))
* add ref parent to field & validators 2 ([9c4593b](https://github.com/hoai/vue-form-generator/commit/9c4593b))
* Add required mark to label if field is required ([40d4499](https://github.com/hoai/vue-form-generator/commit/40d4499))
* add type button ([0df12cc](https://github.com/hoai/vue-form-generator/commit/0df12cc))
* add vfg-field-array into the readme ([7790600](https://github.com/hoai/vue-form-generator/commit/7790600))
* added brackets to conditional ([3249775](https://github.com/hoai/vue-form-generator/commit/3249775))
* added tests and fixed v-attributes binding on components ([e7859b7](https://github.com/hoai/vue-form-generator/commit/e7859b7))
* Alternative solution to expose embeded fields ([c87e932](https://github.com/hoai/vue-form-generator/commit/c87e932))
* build ([55dff90](https://github.com/hoai/vue-form-generator/commit/55dff90))
* Bumped node-sass@4.9.0 for Node 10 Compatibility ([ab04e48](https://github.com/hoai/vue-form-generator/commit/ab04e48))
* cleaned up the "clean up" ([3594edf](https://github.com/hoai/vue-form-generator/commit/3594edf))
* Cleaning of the test ([6bf1cd2](https://github.com/hoai/vue-form-generator/commit/6bf1cd2))
* closes #449 - converted `$field-switch-height` to `30px` in `calc()` call ([ccd4358](https://github.com/hoai/vue-form-generator/commit/ccd4358)), closes [#449](https://github.com/hoai/vue-form-generator/issues/449)
* Code refactoring and fix codacity issues ([320a4b5](https://github.com/hoai/vue-form-generator/commit/320a4b5))
* Correction of build and small corrections ([632911e](https://github.com/hoai/vue-form-generator/commit/632911e))
* created a new "attributes" directive that binds input/wrapper (with support for other named sets) at ([25e7efb](https://github.com/hoai/vue-form-generator/commit/25e7efb))
* Dependency updated ([ebf2202](https://github.com/hoai/vue-form-generator/commit/ebf2202))
* disabled "color" test for fieldInput.spec to enable build ([cf90bd6](https://github.com/hoai/vue-form-generator/commit/cf90bd6))
* Fix and correction to pass Eslint and other checks ([056d9db](https://github.com/hoai/vue-form-generator/commit/056d9db))
* Fix bug in IE11 and Edge ([be30238](https://github.com/hoai/vue-form-generator/commit/be30238))
* fix class ([d9a7784](https://github.com/hoai/vue-form-generator/commit/d9a7784))
* Fix fields exposition (temporary solution) ([de00d3b](https://github.com/hoai/vue-form-generator/commit/de00d3b))
* fix form ([5f820d8](https://github.com/hoai/vue-form-generator/commit/5f820d8))
* fix json ([41cf14d](https://github.com/hoai/vue-form-generator/commit/41cf14d))
* fix label ([4af5df0](https://github.com/hoai/vue-form-generator/commit/4af5df0))
* fix log ([215ba8f](https://github.com/hoai/vue-form-generator/commit/215ba8f))
* Fix submit button not call form validate method ([5ef9cd9](https://github.com/hoai/vue-form-generator/commit/5ef9cd9))
* Fix test and update dependency ([b9ea983](https://github.com/hoai/vue-form-generator/commit/b9ea983))
* Fix URL, rename and move mixinsUtils.js, modify a comment ([90c4673](https://github.com/hoai/vue-form-generator/commit/90c4673))
* Fix version number ([e061755](https://github.com/hoai/vue-form-generator/commit/e061755))
* Fixed #380 - Added vue-multiselect noResult slot option ([f39ec46](https://github.com/hoai/vue-form-generator/commit/f39ec46)), closes [#380](https://github.com/hoai/vue-form-generator/issues/380)
* Include UID for emitted form validation events ([cbfee9c](https://github.com/hoai/vue-form-generator/commit/cbfee9c))
* Make label reactive ([4315931](https://github.com/hoai/vue-form-generator/commit/4315931))
* Progress on test ([59aaf2b](https://github.com/hoai/vue-form-generator/commit/59aaf2b))
* Progress on test ([166ee43](https://github.com/hoai/vue-form-generator/commit/166ee43))
* Progress on test ([49c789c](https://github.com/hoai/vue-form-generator/commit/49c789c))
* readme 2 ([ac4344e](https://github.com/hoai/vue-form-generator/commit/ac4344e))
* Remove .idea ([b006beb](https://github.com/hoai/vue-form-generator/commit/b006beb))
* Remove config file ([e932b58](https://github.com/hoai/vue-form-generator/commit/e932b58))
* Return entire VFG instance with validation event ([0f79d51](https://github.com/hoai/vue-form-generator/commit/0f79d51))
* Rework of formGenerator to use a component ([3f52a20](https://github.com/hoai/vue-form-generator/commit/3f52a20))
* run build ([e83423a](https://github.com/hoai/vue-form-generator/commit/e83423a))
* run build ([c4c7a40](https://github.com/hoai/vue-form-generator/commit/c4c7a40))
* skipping optional fields, proposing these be moved into separate packages for each field to allow fo ([2e192ae](https://github.com/hoai/vue-form-generator/commit/2e192ae))
* Update configuration and dependency ([49043ab](https://github.com/hoai/vue-form-generator/commit/49043ab))
* update readme  ([8a218ea](https://github.com/hoai/vue-form-generator/commit/8a218ea))
* Update to Webpack 3. Almost all dependency are updated. Reorganisation of the config files. Now use  ([163fdc9](https://github.com/hoai/vue-form-generator/commit/163fdc9))
* updated abstractField and fieldImage to clean up errors generated by tests ([4b7f551](https://github.com/hoai/vue-form-generator/commit/4b7f551))
* updated core field tests to use modified nextTick with exception handling, removed "checkbox" test f ([a1f31d3](https://github.com/hoai/vue-form-generator/commit/a1f31d3))
* updated to latest npm packages, added new "basic" dev samples, fixed problems in fieldCheckbox.spec  ([a18f608](https://github.com/hoai/vue-form-generator/commit/a18f608))
* v2.3.5 ([f464697](https://github.com/hoai/vue-form-generator/commit/f464697))
* v2.3.6 ([c1a5979](https://github.com/hoai/vue-form-generator/commit/c1a5979))
* v2.3.7 ([b5dffa6](https://github.com/hoai/vue-form-generator/commit/b5dffa6))
* Validator rule can receive extra parameter. Ex: 'before:dateField' ([7162467](https://github.com/hoai/vue-form-generator/commit/7162467))
* WIP on the unit test ([e97420e](https://github.com/hoai/vue-form-generator/commit/e97420e))
* WIP on unit test ([2d74a15](https://github.com/hoai/vue-form-generator/commit/2d74a15))
* Work on the code coverage ([a858da6](https://github.com/hoai/vue-form-generator/commit/a858da6))
